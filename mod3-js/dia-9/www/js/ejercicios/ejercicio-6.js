...
// const infectados = persons.filter((person) => person.infected === true);
// console.log(infectados.length);
 ...
 *
 */
// console.log(countries.reduce((acc, country) => (acc += country.infected), 0));
 ...
 */
// console.log(
//     countries.reduce((acc, country) => Math.max(acc, country.infected), 0)
// );
 ...
 *
 */
// const nombresAnimales = persons.map((name) => name.petName);
 ...
 *
 */
const personasPerro = persons.filter(
    (person) => person.petName !== null && person.code === 'ES'
);
console.log(personasPerro);
...
const personWithDogs = persons.filter((person) => {
    return pets.find(
        (pet) => pet.petName === person.petName && pet.type === 'perro'
    );
});
console.log();
console.log(personWithDogs);
/**
 *  ###########################
 *  ## E J E R C I C I O   7 ##
 *  ###########################
 ...
 */
console.log(`patas`);
console.log(animals.reduce((acc, leg) => (acc += leg.legs), 0));
/**
 *  ###########################
 *  ## E J E R C I C I O   8 ##
 *  ###########################
...
const cuatroPatas = animals.filter((animal) => animal.legs === 4);
console.log(cuatroPatas);
